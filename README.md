...
I was born on December 25, 1965, at noon precisely, in Nîmes — a Roman city built to celebrate the light, on the day the Romans celebrated Sol Invictus, the invincible sun, at the exact hour of its daily zenith. My feast day is June 24, the summer solstice: Saint John the Baptist, the one who announces what is coming, then steps aside.
...
→ [github.com/JeanHuguesRobert](https://github.com/JeanHuguesRobert) · [github.com/virteal](https://github.com/virteal)

**2025–2026 — MareNostrum**  
A Mediterranean-scale framework treating solar radiation as a democratic common good, governed by federated assemblies on the principle of one person, one vote, with imperative and revocable mandates. The physical substrate is solar exergy. The governance layer is fractal and anti-capture by design. The cognitive layer is an auditable inference registry that makes opacity architecturally impossible.

The thesis: *infrastructure is all you need.*  
...
Ostrom proved that commons can be governed without tragedy.  
Vaswani et al. showed that one architectural insight can reorganize a field.
