...
| 2026-09-10-001 | 2026-09-10 | Sénatoriales 2026 — candidature Baron Mariani : pré-transmission dématérialisée du dossier et demande de rendez-vous | Préfecture de la Haute-Corse — service des élections | 0 | 0 | Première transmission tentée à 17:01 mais rejetée par le serveur destinataire (`552 5.3.4`). Retransmission allégée prête ; huit originaux archivés en privé sur Drive ; miroir public expurgé préparé avec URL stables, mais partage anonyme encore à activer. Limite enregistrée comme fait technique et, dans l’interprétation du principal, comme manifestation de « La Machine à Empêcher ». | D3 |
