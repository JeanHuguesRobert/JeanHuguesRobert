...
| 2026-09-10-001 | 2026-09-10 | Sénatoriales 2026 — candidature Baron Mariani : pré-transmission dématérialisée du dossier et demande de rendez-vous | Préfecture de la Haute-Corse — service des élections | 0 | 0 | Première transmission tentée à 17:01 mais rejetée par le serveur destinataire pour dépassement de taille (`552 5.3.4`). PDF Maguy recompressé, guide DITP remplacé par son URL officielle et retransmission allégée préparée en brouillon dans le même fil ; Laurence et Maguy en copie. Limite enregistrée comme fait technique et, dans l’interprétation du principal, comme nouvelle manifestation de « La Machine à Empêcher ». | D4 |
