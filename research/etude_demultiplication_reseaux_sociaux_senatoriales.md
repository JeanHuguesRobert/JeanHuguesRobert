...
Cette étude définit comment **Agent John** peut devenir le **moteur de démultiplication sociale**, en agissant comme un préparateur ultra-efficace, tout en respectant scrupuleusement le principe inviolable **DHITL** (*Democratic Humans in the Loop*) : **« Agent John prépare et propose ; l'humain valide et publie. »**

---

## 1. Principes Directeurs & Invariants de Sécurité (DHITL)
...
3. **Multi-Formatage Automatique (Démultiplication) :**  
...
## 2. Architecture Technique de la Dérivation Sociale
...
```text
               ...
               └──────────────────────┬───────────────────────┘
                                      ...
                                      ▼
               ┌──────────────────────────────────────────────┐
               │    Moteur de Dérivation Sociale Agent John   │
               ...
               └──────────────────────┬───────────────────────┘
                                      ...
                                      ▼
               ┌──────────────────────────────────────────────┐
               │    Connecteurs d'Émission Sécurisés           │
...
2. **Notification Cockpit :** Agent John envoie sur WhatsApp :
   ```text
   📢 *Agent JHN — Proposition de Publication Sociale*
...
## 5. Feuille de Route d'Implémentation Immédiate (Sprint Sénatoriales)

| Étape | Action Technique | Livrable | Échéance |
| :--- | :--- | :--- | :--- |
| **Étape 1** | Création du module `social-derivation.js` (Découpeur de formats FB/X) | Module de dérivation de texte dans `cogentia` | Immédiat |
